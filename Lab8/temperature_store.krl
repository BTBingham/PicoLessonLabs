ruleset temperature_store {
  ...
  rule notified_need_send_report {
    select when wovyn notify_need_report
    ...
    //always {
      event:send({"eci": x, "domain":"sensor", "type":"receiveReport", "attrs":{"reportNumber":event:attr("reportNumber"), "temperatures": temperatures}});
